object Dependencies {
    ...
    object Androidx {
        ...
        object Navigation {
            ...
            const val FRAGMENT_NAVIGATION_DEPENDENCY = "androidx.navigation:navigation-fragment-ktx:$version"
            const val UI_KTX_NAVIGATION_DEPENDENCY = "androidx.navigation:navigation-ui-ktx:$version"
            const val SAFE_ARGS_DEPENDENCY = "androidx.navigation:navigation-safe-args-gradle-plugin:$version"
        }
        ...
        object Security {
            ...
            const val IDENTITY_CREDENTIAL_DEPENDENCY = "androidx.security:security-identity-credential:$version-alpha03"
            const val APP_AUTHENTICATOR_DEPENDENCY = "androidx.security:security-app-authenticator:$version-alpha02"
            const val APP_AUTHENTICATOR_TESTING_DEPENDENCY = "androidx.security:security-app-authenticator-testing:$version-alpha01"
        }
